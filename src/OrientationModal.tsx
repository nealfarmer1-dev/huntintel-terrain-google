...
export function OrientationModal({ visible, onComplete }: Props) {
  ...
  return <Modal visible={visible} presentationStyle="fullScreen" animationType="slide" onRequestClose={() => { void finish(); }}>
...
const styles = StyleSheet.create({
  ...
  content:{flexGrow:1,justifyContent:"center",padding:20,paddingBottom:28},
