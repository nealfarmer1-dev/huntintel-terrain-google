...
export const fetchTeamAnalyses=id=>request(`/api/terrain/teams/${encodeURIComponent(id)}/analyses`);
export const appendBreadcrumbPoints=(id,breadcrumbId,points)=>request(`/api/terrain/analyses/${encodeURIComponent(id)}/breadcrumbs/${encodeURIComponent(breadcrumbId)}/points`,{method:"POST",body:JSON.stringify({points})});
