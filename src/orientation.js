...
export const TERRAIN_ORIENTATION_STEPS = [
  ...
  { icon: "⌖", kicker: "Step 5", title: "Take It Into the Field", body: "On supported mobile web browsers and in the native Apple and Google apps, open saved analyses, use My Location, navigate to terrain-analysis waypoints, view field maps, add personal notes, and review findings while scouting.", bullets: ["Downloaded analyses remain available offline where supported", "Desktop browsers do not provide the mobile field-navigation experience"] },
