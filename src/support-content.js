...
export const GETTING_STARTED_ARTICLES = [
  ...
  { id: "breadcrumb", title: "Record a Breadcrumb", paragraphs: ["Open Field Navigation and choose Start Breadcrumb. Breadcrumb recording stores your traveled route and can continue in the background on supported native devices after you grant the required location permission. Use Pause, Resume, or Finish / Stop to control recording. Background tracking does not begin automatically."] },
